...
holds 1,712 distinct files, content-addressed, of which
...
> 1,712 candidate documents, stored whole and keyed by the
> keccak-256 of their bytes, so every verdict above stays checkable after the
> originals go offline. 0 of them were written by
